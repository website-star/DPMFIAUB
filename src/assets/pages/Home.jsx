...
export default function Home() {
    ...
    return (
        ...
        <section id='sinergiaksi' className='h-screen sinergiaksi flex justify-center items-center'>
        ...
        <section id='program' className='lg:h-screen flex justify-center items-center mb-10'>
            <div className='  lg:w-5/6 w-full overflow-x-auto '>
                <div className='flex w-full h-[28rem]  lg:justify-center lg:gap-9 gap-4 p-2 '>
                    <Link to="/jaringasmara" className='lg:w-[21%] min-w-[275px]'>
                        <div className='bg-gradient-to-b from-[#2BA097] to-[#103A37] to-95%  h-full rounded-lg' style={{boxShadow:"0px 5px 15px rgba(0, 0, 0, 0.35)"}}>
                    ...
                    <Link to="/produkhukum"  className='lg:w-[21%] min-w-[275px]'>
                        <div className='bg-gradient-to-b from-[#2BA097] to-[#103A37] to-95%  h-full  rounded-lg' style={{boxShadow:"0px 5px 15px rgba(0, 0, 0, 0.35)"}}>
                            ...
                            <div className='bg-white h-1/2 rounded-b-lg flex flex-col gap-2 items-center pt-7 p-3'>
                                ...
                                <span className='font-SFRegular text-sm text-justify '>Keputusan resmi yang dikeluarkan oleh DPM FIA UB untuk mengatur, mengawasi, dan memberikan panduan dalam menjalankan kegiatan serta memastikan kepatuhan terhadap aturan internal FIA.</span>
                            </div>
                        </div>
                    </Link>
                    <Link to="/pressrelease"  className='lg:w-[21%] min-w-[275px]'>
                        <div className='bg-gradient-to-b from-[#2BA097] to-[#103A37] to-95% h-full  rounded-lg' style={{boxShadow:"0px 5px 15px rgba(0, 0, 0, 0.35)"}}>
                            <div className='h-1/2 rounded-t-lg flex justify-center items-center'>
                            ...
                            <div className='bg-white h-1/2 rounded-b-lg flex flex-col gap-2 items-center pt-7 p-3'>
                                ...
                                <span className='font-SFRegular text-sm text-justify '>Pernyataan tertulis resmi yang dirancang untuk mengumumkan informasi penting dari DPM FIA UB kepada Mahasiswa FIA UB.</span>
                            </div>
                            </div>
                    </Link>
                        </div>
